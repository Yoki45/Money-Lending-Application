...
public interface ILoanService {
    ...
    LoanReportDTO fetchLoanDetails(LoanStatus status, Long loanId, String range, Long customer, Long product, Long accountNumber, Integer page, LoanType loanType);
